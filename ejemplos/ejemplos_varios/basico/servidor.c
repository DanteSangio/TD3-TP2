...
{
    //pid -1 espera por cualquier proceso hijo
    //sin status
    //options WNOHANG retorna si no termino ningun hijo
...
{
    pthread_t threadId;
    // le paso la estructura sin atributos y le indico ejecutar zombie hunter
